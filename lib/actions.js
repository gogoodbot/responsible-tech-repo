...
export async function getDataWithName(query) {
  console.log("query", query);
  try {
    const resultsArray = await Promise.all([
      searchTable("Organization", ["name"], query),
      searchTable("Stakeholder", ["name"], query),
      searchTable("Policy", ["name"], query),
      searchTable("Resource", ["name"], query),
      searchTable("Litigation", ["name"], query),
    ]);
