...
const SeeLessButton = ({ onClick }) => {
    return (
        <div className="flex gap-x-2.5 items-center self-end">
            <button className="shadow text-base font-bold uppercase flex items-center justify-center gap-2 bg-[#A3E2EC] px-2 py-2.5 rounded-md min-w-[116px] hover:bg-[#95dbe6]"><SearchIcon size={20} />find more</button>
