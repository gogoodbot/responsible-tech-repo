                ...
                <div className="flex items-center gap-4">
                    ...
                    <Link className="border-2 w-[45px] h-[45px] border-white border-opacity-25 rounded-full flex items-center justify-center" href='/'>
                        <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M3.5 6.5C3.5 8.29238 4.92333 9.75 6.67352 9.75C8.42372 9.75 9.84705 8.29238 9.84705 6.5C9.84705 4.70763 8.42372 3.25 6.67352 3.25C4.92333 3.25 3.5 4.70763 3.5 6.5ZM5.08594 6.5C5.08594 5.60381 5.7976 4.875 6.6727 4.875C7.5478 4.875 8.25946 5.60381 8.25946 6.5C8.25946 7.39619 7.5478 8.125 6.6727 8.125C5.7976 8.125 5.08594 7.39619 5.08594 6.5Z" fill="white" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M3.50165 13H9.84869C11.4799 13 13.0222 11.4205 13.0222 9.75V3.25C13.0222 1.5795 11.4799 0 9.84869 0H3.50165C1.87046 0 0.328125 1.5795 0.328125 3.25V9.75C0.328125 11.4205 1.87046 13 3.50165 13ZM1.91406 3.25C1.91406 2.49031 2.75901 1.625 3.50082 1.625H9.84787C10.5897 1.625 11.4346 2.49031 11.4346 3.25V9.75C11.4346 10.5097 10.5897 11.375 9.84787 11.375H3.50082C2.74473 11.375 1.91406 10.5243 1.91406 9.75V3.25Z" fill="white" />
                        </svg>
