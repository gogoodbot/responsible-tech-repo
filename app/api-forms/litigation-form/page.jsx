// ATTENTION:
// this is a sample code for Litigation Form.
// This contains issues, and fields that need to be handled in the BE like dates and ...
//  Other forms can be written based on this general layout to be used on Dashboard page
