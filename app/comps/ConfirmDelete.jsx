  ...
  return (
    <div className='p-6 text-center space-y-6'>
      ...
      <div className='flex justify-center gap-4 mt-6'>
        ...
        <Button
          variant='danger'
          className='px-5 py-3 rounded-md font-medium bg-red-600 text-white border border-red-600 hover:bg-red-700 hover:border-red-700 dark:bg-red-500 dark:text-gray-900 dark:border-red-500 dark:hover:bg-red-600 dark:hover:border-red-600 transition-colors duration-150'
        >
          Delete
        </Button>
      </div>
